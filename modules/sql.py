...
def create_pre_general_table(tablename, args, db, cursor):
    fields = (  # PLSP57501_17062014lambda_3216_1_ch101_file10_strand
        ...
        'sampling_rate float',
        '1minwin INT, INDEX(1minwin)',
        '5minwin INT, INDEX(5minwin)',
        '10minwin INT, INDEX(10minwin)',
        '15minwin INT, INDEX(15minwin)',
        's1minwin INT, INDEX(s1minwin)',
        's5minwin INT, INDEX(s5minwin)',
        's10minwin INT, INDEX(s10minwin)',
        's15minwin INT, INDEX(s15minwin)',
        'g_1minwin INT, INDEX(g_1minwin)',
        'g_5minwin INT, INDEX(g_5minwin)',
        'g_10minwin INT, INDEX(g_10minwin)',
        'g_15minwin INT, INDEX(g_15minwin)',
        'g_s1minwin INT, INDEX(g_s1minwin)',
        'g_s5minwin INT, INDEX(g_s5minwin)',
        'g_s10minwin INT, INDEX(g_s10minwin)',
        'g_s15minwin INT, INDEX(g_s15minwin)',
...
def create_general_table(tablename, args, db, cursor):
    fields = (  # PLSP57501_17062014lambda_3216_1_ch101_file10_strand
        ...
        'complement_model TEXT(200) ',
        'max_events INT(10) ',
        'input VARCHAR(200) ',
        'min_events INT(4) ',
        'config VARCHAR(100) ',
        'template_model VARCHAR(200) ',
        'channel INT(4) ',
...
def create_trackingid_table(tablename, args, db, cursor):
    fields = (  # PLSP57501_17062014lambda_3216_1_ch101_file10_strand
        ...
        'exp_start_time INT(15) NOT NULL',
        'flow_cell_id VARCHAR(20) NOT NULL',
