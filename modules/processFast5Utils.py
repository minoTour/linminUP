...
def get_main_timings(hsh, location, hdf):
    ...
    hsh = calcTimingWindows(hsh, start_time, end_time
                                        , g_start_time, g_end_time)
...
def calcTimingWindows(hsh, start_time, end_time, g_start_time, g_end_time):
...
def getBasenameData(args, read_type, hdf):
    ...
    if read_type == 4:
        return getNanonetBasenameData(args, read_type, hdf)
    else:
